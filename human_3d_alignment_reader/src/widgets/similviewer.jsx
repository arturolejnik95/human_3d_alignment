...
class GenoViewer extends React.Component {
    ...
    animate() {
        ...
        if (!this.props.blockView) {    
            if (this.props.result != this.state.round) {
                this.setState({ round: this.props.result }, function() {
                    console.log(`Round in sim: `, this.state.round);
                });
                this.viewer.add2Genotypes(  this.props.genotype1, this.props.genotype2,
                                            this.props.position1, this.props.position2,
                                            this.props.rotation1, this.props.rotation2,
                                            this.props.selected1, this.props.selected2);
            }
            if (this.props.result == this.state.round) {
